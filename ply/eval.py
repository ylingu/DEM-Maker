...
def filter_depth(args, scan: str = ""):
    ...
    ply_filename = os.path.join("fused.ply")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default="checkpoints\params_000007.ckpt", help="load a specific checkpoint for parameters of model")
